      ...
      <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6">
        ...
        <FadeIn>
          <section className="mt-12">
            <h2 className="text-xl font-medium text-ink-900">{t("docTypesTitle")}</h2>
              ...
              {DOC_TYPE_CODES.map((d) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="grid size-11 place-items-center rounded-xl bg-ink-900 font-mono text-sm font-medium text-paper" dir="ltr">
                      {d.code}
                    </span>
        ...
        <FadeIn>
          <section className="mt-12">
            <h2 className="text-xl font-medium text-ink-900">{t("flagsTitle")}</h2>
              ...
              <table className="w-full min-w-[560px] text-sm">
                <thead>
                  <tr className="border-b border-ink-200 bg-ink-50 text-xs uppercase tracking-wide text-ink-500">
                    <th className="px-4 py-3 text-start font-medium">{t("flagName")}</th>
                    <th className="px-4 py-3 text-start font-medium">{t("flagValue")}</th>
                    <th className="px-4 py-3 text-start font-medium">{t("flagDescription")}</th>
                  </tr>
                </thead>
                  ...
                  {TRANSACTION_FLAGS.map((f) => (
                    <tr key={f.name} className="hover:bg-brand-50/30">
                      ...
                      <td className="px-4 py-3">
                        <code className="rounded-md bg-ink-900 px-2 py-0.5 font-mono text-xs font-medium text-white" dir="ltr">
                          {f.flags}
                        </code>
                      </td>
        ...
        <FadeIn>
          <section className="mt-12">
            <h2 className="text-xl font-medium text-ink-900">{t("fieldsTitle")}</h2>
