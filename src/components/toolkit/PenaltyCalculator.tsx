  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr]">
      <div className="rounded-3xl border border-ink-100 bg-white p-6 sm:p-8">
        <h2 className="text-lg font-medium text-ink-900">{t("inputsTitle")}</h2>
        ...
        <div className="mt-5 space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="pc-noasp" className="mb-1.5 block text-sm font-medium text-ink-800">
                {t("monthsNoAsp")}
              </label>
              <input
                id="pc-noasp"
            ...
            <div>
              <label htmlFor="pc-notlive" className="mb-1.5 block text-sm font-medium text-ink-800">
                {t("monthsNotLive")}
              </label>
              <input
                id="pc-notlive"
            ...
            <div>
              <label htmlFor="pc-outside" className="mb-1.5 block text-sm font-medium text-ink-800">
                {t("invoicesOutside")}
              </label>
              <input
                id="pc-outside"
            ...
            <div>
              <label htmlFor="pc-outmonths" className="mb-1.5 block text-sm font-medium text-ink-800">
                {t("monthsOutside")}
              </label>
              <input
                id="pc-outmonths"
            ...
            <div className="sm:col-span-2">
              <label htmlFor="pc-days" className="mb-1.5 block text-sm font-medium text-ink-800">
                {t("daysUnreported")}
              </label>
              <input
                id="pc-days"
      ...
      <div className="flex flex-col gap-5">
        ...
        >
          ...
          <m.p
            ...
            className="mt-2 text-4xl font-medium tabular-nums sm:text-5xl"
            dir="ltr"
          >
        ...
        <div className="rounded-3xl border border-brand-100 bg-brand-50 p-6 text-center">
          <p className="font-medium text-brand-900">{t("ctaTitle")}</p>
