      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative min-w-[240px] flex-1">
          ...
          <input
            ...
            dir="ltr"
            className="h-12 w-full rounded-xl border border-ink-200 bg-white pe-4 ps-10 text-base placeholder:text-ink-400 focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
          />
        </div>
        <label className="flex cursor-pointer items-center gap-2 rounded-xl border border-ink-200 bg-white px-4 py-3 text-sm font-medium text-ink-700">
          <input
            type="checkbox"
            checked={uaeOnly}
        ...
        <AnimatePresence initial={false}>
          {filtered.map((f) => (
            <m.article
              ...
              className="rounded-2xl border border-ink-100 bg-white p-4 transition-colors sm:p-5"
            >
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-md bg-ink-900 px-2 py-0.5 font-mono text-xs font-medium text-white" dir="ltr">
                  {f.id}
                </span>
